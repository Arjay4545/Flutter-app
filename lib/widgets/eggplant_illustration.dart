...
class EggplantPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    eggplantPath.addOval(Rect.fromLTWH(eggplantX, eggplantY, eggplantWidth, eggplantHeight));
    ...
    canvas.drawOval(
      Rect.fromLTWH(eggplantX + eggplantWidth * 0.15, eggplantY + eggplantHeight * 0.2, 
                   eggplantWidth * 0.3, eggplantHeight * 0.4),
      highlightPaint,
    );
    ...
    for (int i = 0; i < 5; i++) {
      ...
      final x = calyxCenterX + 15 * (i % 2 == 0 ? 1 : 0.6) * (i == 0 ? 1 : 1) * 
                (i == 0 ? 1 : (angle < 0 ? -1 : 1)) * 0.8;
    ...
    for (int i = 0; i < 4; i++) {
      ...
      final leafX = calyxCenterX + 12 * (leafAngle == 0 ? 1 : (leafAngle == 3.14159 ? -1 : 0));
      final leafY = calyxY + 12 * (leafAngle == 3.14159/2 ? -1 : (leafAngle == 3*3.14159/2 ? 1 : 0));
    ...
    leftLeafPath.quadraticBezierTo(
      size.width / 2 - 25, size.height * 0.45,
      size.width / 2 - 20, size.height * 0.35,
    );
    leftLeafPath.quadraticBezierTo(
      size.width / 2 - 15, size.height * 0.4,
      size.width / 2 - 5, size.height * 0.45,
    );
    leftLeafPath.close();
    ...
    rightLeafPath.quadraticBezierTo(
      size.width / 2 + 25, size.height * 0.55,
      size.width / 2 + 20, size.height * 0.45,
    );
    rightLeafPath.quadraticBezierTo(
      size.width / 2 + 15, size.height * 0.5,
      size.width / 2 + 5, size.height * 0.55,
    );
    rightLeafPath.close();
